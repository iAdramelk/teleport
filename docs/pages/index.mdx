...
<Collapsible title="Collapsible header" scope="oss">
...
<Tabs>
  <TabItem label="Tab one" scope="oss">Tab one content</TabItem>
  <TabItem label="Tab two" scope="enterprise">Tab two content</TabItem>
  <TabItem label="Tab three" scope="cloud">Tab three content</TabItem>
  <TabItem label="Tab four">Tab four content</TabItem>
</Tabs>
